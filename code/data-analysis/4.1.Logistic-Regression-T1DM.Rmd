---
title: "Replication project - 4 - Logistic Regression - T1DM vs controls"
output:
...
```{r , echo=FALSE, warning=FALSE, message = FALSE}
kable(diab1_coef_diab, digits = 3, row.names = FALSE, align = "lccc", caption = "Diabetes coefficient from each logistic model in T1Ds matched cohort" )
...
g <- ggplot(data=diab1_coef_diab, aes(y=index, x=OR, xmin = X2.5.. , xmax = X97.5..)) +
  ...
  labs(title = "T1D coefficient from each model", x='Odds ratio', y = 'Variable') +
  theme_minimal() +
