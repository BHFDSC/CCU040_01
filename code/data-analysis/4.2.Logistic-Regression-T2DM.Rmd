---
title: "Replication project - 4 - Logistic Regression - T2DM vs controls"
output:
...
```{r , echo=FALSE, warning=FALSE, message = FALSE}
kable(diab2_coef_diab, digits = 3, row.names = FALSE, align = "lccc", caption = "Diabetes coefficient from each logistic model in T2Ds matched cohort" )
...
g <- ggplot(data=diab2_coef_diab, aes(y=index, x=OR, xmin = X2.5.. , xmax = X97.5..)) +
  ...
  labs(title = "T2D coefficient from each model", x='Odds ratio', y = 'Variable') +
  theme_minimal() +
