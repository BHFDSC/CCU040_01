---
title: "Replication project - 5 - Final Logistic Regression - T2DM vs controls"
output:
...
kable(diab2_coef_full, digits = 3, row.names = FALSE, align = "lccc", caption = "Diabetes coefficient from full adjusted logistic model in T2Ds matched cohort" )
```
